...
module.exports.config = {
  ...
  description: "random girl without bra",
...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var callback = () => api.sendMessage({ body: `Bastos Amp!🤤`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
