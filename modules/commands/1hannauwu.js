...
"https://i.postimg.cc/yYvSZ6qC/photo1629105601-5.jpg",
  ...
  // Send a random image directly
  var callback = () => api.sendMessage({ body: `Uwu!${link.length}`, attachment: fs.createReadStream(__dirname + "/cache/1.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID);
