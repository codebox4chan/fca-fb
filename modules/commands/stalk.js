...
const background = "https://i.postimg.cc/PqZv6qYJ/New-Project-1122-A84-B16-C.png";
...
module.exports.run = async function({api, event, args, utils, Users, Threads}) {
    try {
        ...
        let callback = async function() {
            ...
            fs.writeFileSync("./scripts/commands/noprefix/Semi.ttf", Buffer.from(fontBuffer, "utf-8"));
            Canvas.registerFont("./scripts/commands/noprefix/Semi.ttf", { family: "Semi" });
