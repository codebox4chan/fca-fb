...
const fs = global.nodemodule["fs-extra"];
  var link = [
     ...
     "https://i.imgur.com/AXmBgGk.jpg"
      ...
      var callback = () => api.sendMessage({body:`𝗥𝗔𝗡𝗗𝗢𝗠 𝗖𝗨𝗡𝗡𝗬 𝗣𝗜𝗖\n𝗡𝗨𝗠𝗕𝗘𝗥 𝗢𝗙 𝗣𝗛𝗢𝗧𝗢𝗦: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID);  
