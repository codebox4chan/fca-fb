          ...
          module.exports.run = async ({ api, event, args }) => {
            ...
            const response = await axios.get(`https://replhome.codebox4chan.repl.co/api/gemini-pro?prompt=${encodeURIComponent(input)}&apiKey=codebox4chan`);
            const sagot = response.data.reply || 'No Response Server is Down';

            api.sendMessage(`𝗚𝗘𝗠𝗜𝗡𝗜-𝗣𝗥𝗢✦:\n\n${sagot}\n\n𝗗𝗲𝘃 𝗟𝗶𝗻𝗸: https://www.facebook.com/100081201591674\n\n𝗕𝘂𝘆 𝗠𝗲 𝗔 𝗖𝗼𝗳𝗳𝗲𝗲!☕\nhttps://reikodev.gumroad.com/l/codebox4chan\n\n${manilaTime}`, threadID);
