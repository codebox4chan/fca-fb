...
"https://i.postimg.cc/J7Qvbzc1/zpbi-Yu-P1-WBTUrc.jpg",
  ...
  const response = await axios.get(getRandomLink(), { responseType: "arraybuffer" });
  const buffer = Buffer.from(response.data, "utf-8");
  await fs.writeFile(__dirname + `/cache/${event.senderID}.png`, buffer);
