...
module.exports.languages = {
    ...
    "en": {
        ...
        "notiBox": "🤖ROBOTエーアイ  Connected Successfully✓!\nUse /help for more info :>",
...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
    ...
    if (isNaN(body) && body.indexOf("c") == 0 || body.indexOf("cancel") == 0) {
        ...
        for (const singleIndex of index) {
            if (isNaN(singleIndex) || singleIndex <= 0 || singleIndex > handleReply.pending.length) return api.sendMessage(getText("invalidNumber", singleIndex), threadID, messageID);
...
module.exports.run = async function({ api, event, getText }) {
    ...
    var msg = "100078506104889", index = 1;
